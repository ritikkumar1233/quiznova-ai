...
return [
    ...
    */
    ...
    'default' => 'anthropic', // Priority: anthropic → gemini → openai → ollama (local dev)
        ...
        'ollama' => [
            ...
            'models' => [
                'text' => [
                    ...
                    'cheapest' => env('OLLAMA_MODEL', 'qwen3:8b'),
                    'smartest' => env('OLLAMA_MODEL_SMART', 'qwen2.5-coder:14b'),
                ],
            ],
        ],
